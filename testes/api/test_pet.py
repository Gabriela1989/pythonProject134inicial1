...
from util.leitura import ler_csv
...
def teste_incluir_pet():
    # Configura / Prepara
    # Dados de entrada proveem do pet1.json
    ...
    resultado_obtido = requests.post(
        url=url,
        headers=headers,
        data=open('C:\\Users\\dell\\PycharmProjects\\pythonProject134inicial1\\vendors\\json\\pet1.json')
    )
...
def teste_alterar_pet():
    ...
    resultado_obtido = requests.put(
        url=url,
        headers=headers,
        data=open('C:\\Users\\dell\\PycharmProjects\\pythonProject134inicial1\\vendors\\json\\pet2.json')
    )
...
@pytest.mark.parametrize(
    ...
    ler_csv('C:\\Users\\dell\\PycharmProjects\\pythonProject134inicial1\\vendors\\csv\\massa_incluir_pet.csv')
)
